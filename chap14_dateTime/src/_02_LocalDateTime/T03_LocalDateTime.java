...
//		System.out.println(day1);
		...
		System.out.println(today.plusYears(3).format(dtf));		// 3년 후
		System.out.println(today.plusMonths(5).format(dtf));	// 5개월 후
		System.out.println(today.plusDays(100).format(dtf));	// 100일 후
		System.out.println("--------------------------------");

		System.out.println(today.minusYears(5).format(dtf));	// 5년 전
		System.out.println(today.minusMonths(5).format(dtf));	// 5개월 전
		System.out.println(today.minusDays(100).format(dtf));	// 100일 전
		System.out.println("--------------------------------");
