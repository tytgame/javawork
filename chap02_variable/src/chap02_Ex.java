...
//		   3.4  iNum1 / iNum2 한 결과 소수점까지 나오게 출력하기
				System.out.println((double)iNum1 / iNum2);  	// int/int = int(몫만 나옴)
				
//		   3.5  iNum1 / fNum 한 결과 3이 출력되게 하시오
				float flo = iNum1 / fNum;
				System.out.println((int)flo);				    // (int) / (float) = (float)
...
//				iNum1 / fNum --> 둘 중 하나 double로 변경
				double result3 = iNum1/fNum;
