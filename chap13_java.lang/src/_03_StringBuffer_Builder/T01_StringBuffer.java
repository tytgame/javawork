...
public class T01_StringBuffer {
	...
	public static void main(String[] args) {
		...
		// insert(얼마큼 떨어져서, 문자열)
		sb1.insert(1, "java");
		System.out.println("1글자 뒤에 java 삽임 : " + sb1);
		sb1.insert(5, "김");
		...
		System.out.println("sb1의 글자를 꺼꾸로 : " + sb1.reverse());
		
		// capacity() : StringBuffer의 크기
		//				객체가 생성될때 기본버퍼의 크기는 기존문자 + 16문자
		...
		StringBuffer sb5 = new StringBuffer(32);
		System.out.println("sb3 버퍼의 크기 : " + sb3.capacity());
		System.out.println("-----------------------------------");

		
		StringBuffer sb6 = new StringBuffer("김");
		System.out.println("sb3 버퍼의 크기 : " + sb3.capacity());		
