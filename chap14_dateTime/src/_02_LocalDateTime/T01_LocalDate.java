...
public class T01_LocalDate {
	public static void main(String[] args) {
		...
		System.out.println(today.getDayOfMonth() + "일"); // 30일 중 날짜
		System.out.println("365일중 " + today.getDayOfYear() + "일"); // 365일 중 날짜
		...
		System.out.println("올 해는 총 " + day.lengthOfYear() + "일까지 있다");
	}
