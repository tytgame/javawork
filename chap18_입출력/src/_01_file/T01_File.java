...
//			File f2 = new File("C:\\test2.txt");
			File f2 = new File("C:/Users/tj/yys/test2.txt");
			f2.createNewFile();
			
			// 3. 폴더를 생성하고 파일까지 생성하기
			File tempFolder = new File("C:/Users/tj/yys/temp");
			tempFolder.mkdir();
			
			File f3= new File("C:/Users/tj/yys/temp/test.txt");
			f3.createNewFile();
			
			System.out.println(f1.exists());	// f1파일은 존재하는가?
			System.out.println(f1.isFile());	// f1은 파일인가?
			System.out.println(tempFolder.isFile());	//temp폴더는 파일인가?
